(function () {
  ...
  function renderUnitGuide(ast,f) {
    ...
    $('#symbol-guide').innerHTML=`<div class="guide-heading"><h2>Størrelserne i formlen</h2><span>Tal og enheder fra opgaven</span></div><p class="unit-intro" id="value-input-help">Skriv eventuelt opgavens tal, fx 50 eller 2,5, og vælg enheden. Med visningen Begge står enhed og symbol med småt efter tallet. Et tomt felt beholder symbolet. Nødvendige omregninger sættes ind og forkortes automatisk; selve resultatet beregner du på din lommeregner.</p><dl class="symbol-list unit-symbol-list">${vars.map((v,i)=>{
  ...
  function finishTutorial() {
    ...
    tutorial = null;
    ({model,activeId,selected,expanded,geometryView,previewPose,libraryQuery,valueDrafts,valueDisplay} = previous);
  ...
  function startTutorial() {
    if (tutorial) return;
    tutorial = {model,activeId,selected,view,expanded,geometryView,previewPose:preview3D?.getPose()||previewPose,libraryQuery,valueDrafts,valueDisplay,
